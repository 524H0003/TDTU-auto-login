...
packages:
  ...
  conventional-changelog-writer@8.3.0:
    resolution: {integrity: sha512-l5hDOHjcTUVtnZJapoqXMCJ3IbyF6oV/vnxKL13AHulFH7mDp4PMJARxI7LWzob6UDDvhxIUWGTNUPW84JabQg==}
    engines: {node: '>=18'}
    hasBin: true
...
snapshots:
  ...
  '@commitlint/load@20.4.3(@types/node@25.3.3)(typescript@5.9.3)':
    dependencies:
      '@commitlint/config-validator': 20.4.3
      '@commitlint/execute-rule': 20.0.0
      '@commitlint/resolve-extends': 20.4.3
